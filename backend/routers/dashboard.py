...
# Called by: analyticsAPI.summary() → GET /dashboard/analytics
#            analyticsAPI.plan()    → GET /dashboard/plan
# ══════════════════════════════════════════════════════════════════
...
def get_plan(
    ...
    return {
        "plan":             company.plan,
        "questions_used":   info["questions_used"],
        "questions_limit":  info["questions_limit"],
        "domains_used":     info["domains_used"],
        "domains_limit":    info["domains_limit"],
        "max_md_size_kb":   info.get("max_md_size_kb", 500),
    }
